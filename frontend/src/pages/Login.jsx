...
export default function Login() {
    ...
    const handleGoogleLogin = () => {
        ...
        /*
          Redirect user to Spring Security OAuth endpoint

          Auth Service:
          localhost:8081

          Public ngrok URL:
          maker-neglector-unpiloted.ngrok-free.dev
        */


        window.location.href =
        "https://maker-neglector-unpiloted.ngrok-free.dev/oauth2/authorization/google";
        ...
        <div className="auth-screen">
            ...
            <div className="auth-screen__side">
                ...
                <p className="auth-screen__copy">
                    ...
                    Compare, convert, add, subtract, and divide
                    across length, weight, volume, and temperature
                    with complete calculation history.
            ...
            <div className="auth-screen__form">
                ...
                <Card className="auth-card">
                    ...
                    <p className="auth-card__copy">
                        ...
                        Your account is authenticated through OAuth2
                        and secured using JWT tokens.
                    ...
                    <p className="auth-card__footnote">
                        ...
                        New here?
                        Continuing with Google automatically
